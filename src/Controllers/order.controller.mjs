...
const createOrder = catchAsync(async (req, res) => {
    ...
    const order = new Order({
        ...req.body,
        user:new mongoose.Types.ObjectId(getUserIdFromToken(token)),
        products: products,
        total: total,
    });
...
export {createOrder,getAllOrders,getOrderById,updateOrderById,deleteOrderById,cancelOrder,viewOrdersOfUser};
